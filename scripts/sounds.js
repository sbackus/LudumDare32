...
var reflect = new Howl({urls: ['././Audio/5069__juskiddink__bells-and-gongs/122682__juskiddink__steel-bar-instrument.wav'], volume: 0.2 }); //plays when you redirect an enemy
